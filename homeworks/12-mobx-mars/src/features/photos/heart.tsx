...
export const Heart = (props: HeartProps): JSX.Element => (
    <svg width="98" height="89" viewBox="0 0 98 89" fill="none" xmlns="http://www.w3.org/2000/svg" opacity="0.7" className="heart" onClick={props.onClick}>
